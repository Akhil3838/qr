...
function Dashboard() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => setLoadingTab(false), 1000);
        ...
        return (
          <div>
            ...
            {[1, 2].map((i) => (
              <div
                key={i}
                className="d-flex flex-column flex-md-row justify-content-between border shadow-sm align-items-center mt-4 p-3 bg-light rounded"
              >
                ...
                <div className="d-flex flex-column flex-sm-row">
                  <Link href={"/negreview"}>
                    <button
                      className="btn btn-sm btn-outline-danger mb-2 mb-sm-0 me-sm-2"
        ...
        return (
          <div>
            ...
            <p className="text-muted">
              Track your payment history and current payment status.
            </p>
          </div>
        );
  ...
  return (
    ...
    >
      ...
      <section className="banner-style5-are">
                  ...
                  <li className="nav-item" key={item.key}>
                    <button
                      ...
                      style={{
                        borderRadius: "0",
                        borderRight:
                          index !== array.length - 1 ? "1px solid #dee2e6" : "none",
                        backgroundColor:
                          activeSection === item.key ? "" : "transparent",
                      }}
